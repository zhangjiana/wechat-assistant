...
module.exports = {
   ...
   */
  ROOMLIST: [
    {roomName:'八十大寿', sortId:22, endWord:'QQ阅读君',date:'0 30 7 * * *'},
  ],
   /**
   ...
   * 好友进群通知，可配置多个
   */
  ROOMJOINLIST: [{name:'阅文集团-2020年-校招内推',
    welcome:'阅文集团2020年秋季校园招聘已经开启（http://t.cn/RppUPzE）\n 。今年走“内推码”机制，有内推码的可以免Hr简历删选，技术岗可以直接进入笔试环节。\n内推码在申请职位填写信息的时候填写.我的”内推码” 681042，每个码限30个名额，用完后再联系我更换。\n \n我在阅文等你来～～～'}],
  /**
   * 关键词回复列表
